...
const T = {
  ...
  borderLav: "rgba(167,139,202,0.35)",
...
const formStyles = `
  ...
  @keyframes af-sparkle { 0%,100%{opacity:0.4;transform:scale(0.9)} 50%{opacity:1;transform:scale(1.1)} }
  ...
  <Box
    sx={{
      ...
      "&:focus-within": {
        ...
        boxShadow: error
          ? `0 0 0 2px ${T.rose}22`
          : `0 0 0 2px ${T.gold}18, 0 6px 20px ${T.shadow}`,
...
const Ornament = () => (
  <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, my: 0.5 }}>
    ...
    />
    <Box
      sx={{ fontSize: 10, color: T.goldLight, letterSpacing: 5, opacity: 0.7 }}
    >
      ✦ ✦ ✦
    </Box>
    <Box
...
const AttendanceForm: React.FC<AttendanceFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!form.nombre.trim())
      return triggerError("Por favor, dinos tu nombre completo ✨");
    if (!form.telefono.trim())
      return triggerError("Ingresa tu número de WhatsApp 📱");
    if (!form.autorizado)
      return triggerError("Confirma que deseas enviar tu mensaje 💕");

    const txt =
      form.confirmacion === "si"
        ? `👑 *¡CONFIRMO ASISTENCIA!* 👑\n\nQuerida ${quinceanera}, ¡qué emoción! 🎀✨\n\n✅ Asistiré: ¡SÍ!\n👥 Acompañantes: ${form.acompanantes}\n${form.mensaje ? `\n💌 "${form.mensaje}"\n` : ""}\n¡Nos vemos en tus XV! 💃🎊\nCon cariño, ${form.nombre} 💫`
        : `💔 *NO PODRÉ ASISTIR* 💔\n\nQuerida ${quinceanera},\n\n❌ Lamentablemente no podré acompañarte en tus XV.\n${form.mensaje ? `\n💌 "${form.mensaje}"\n` : ""}\n¡Que tengas el día más hermoso! 👑✨\nCon cariño, ${form.nombre} 💕`;
    ...
    window.open(
      `https://wa.me/${numeroContacto}?text=${encodeURIComponent(txt)}`,
      "_blank",
    );
    setEnviado(true);
    setError("");
        ...
        <Box sx={{ textAlign: "center", py: 4 }}>
          <Box
            sx={{
              ...
              height: 72,
              borderRadius: "50%",
              background: `linear-gradient(135deg, ${T.pink}, ${T.lavenderDark})`,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              mx: "auto",
              mb: 2,
              boxShadow: `0 0 0 8px ${T.pink}18, 0 8px 24px ${T.shadow}`,
            }}
          >
          ...
          >
            Tu mensaje ha llegado a ${quinceanera}.<br />
            ¡Nos vemos en sus XV! 👑✨
          </Typography>
          <Box
          ...
          >
            {["👑", "✨", "🎀", "💖", "💃"].map((emoji, i) => (
              <Box
                key={i}
                sx={{
                  fontSize: 12 + Math.abs(2 - i) * -2 + 6,
                  opacity: 0.6,
                  animation: `af-sparkle ${1.4 + i * 0.15}s infinite`,
      ...
      <form onSubmit={handleSubmit} noValidate>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
          {error && (
            ...
            >
              <HeartBorderIcon
                sx={{ fontSize: 16, color: T.rose, flexShrink: 0 }}
              />
              <Typography
                sx={{
                  fontFamily: serifFont,
          ...
          <Box className="af-reveal af-reveal-3">
            ...
            >
              ¿Acompañarás a {quinceanera} en sus XV?
            </Typography>
              ...
              >
                ...
                <Typography
                  sx={{
                    ...
                    fontWeight: 500,
                    fontSize: 15,
                    color: form.confirmacion === "si" ? T.greenDark : T.text,
                  }}
                >
                  ¡Sí, confirmo!
                </Typography>
              ...
              >
                ...
                <Typography
                  sx={{
                    ...
                    fontWeight: 500,
                    fontSize: 15,
                    color: form.confirmacion === "no" ? T.roseDark : T.text,
                  }}
                >
                  No podré ir
                </Typography>
          ...
          <Box className="af-reveal af-reveal-4">
            <Field label="Un mensaje para la quinceañera" emoji="💌">
              <textarea
                name="mensaje"
                rows={3}
                value={form.mensaje}
                placeholder={
                  form.confirmacion === "si"
                    ? "Escribe algo especial para ella… una felicitación, un recuerdo 👑💕"
                    : "Aunque no puedas ir, déjale un mensaje 💕"
                }
          ...
          <Box
            ...
            sx={{
              ...
              boxShadow: form.autorizado
                ? `0 6px 20px rgba(217,77,106,0.14)`
                : `0 4px 14px ${T.shadow}`,
            ...
            <Box>
              <Typography
                sx={{
                  ...
                  fontSize: 14,
                  fontWeight: 500,
                  color: form.autorizado ? T.roseDark : T.text,
                  lineHeight: 1.4,
                }}
              >
                Confirmo que quiero enviar este mensaje a {quinceanera}
              </Typography>
              <Typography
                sx={{
                  fontFamily: serifFont,
              ...
              >
                Se abrirá WhatsApp para compartir tu confirmación directamente
                💕
              </Typography>
            </Box>
          </Box>
          ...
          <Box className="af-reveal af-reveal-6">
            <Box
              ...
              sx={{
                ...
                color: "#fff",
                background: form.autorizado
                  ? `linear-gradient(135deg, ${T.pink} 0%, ${T.lavenderDark} 100%)`
                  : "rgba(180,130,80,0.2)",
                border: "none",
                borderRadius: "32px",
                py: 1.8,
                ...
                boxShadow: form.autorizado
                  ? `0 10px 30px rgba(217,77,106,0.30)`
                  : "none",
                transition: "all 0.3s",
                mt: 1,
              }}
            >
              ...
              <HeartIcon
                sx={{
                  fontSize: 16,
                  animation: form.autorizado ? "af-pulse 2s infinite" : "none",
                }}
              />
            </Box>
          </Box>
          ...
          >
            Tu mensaje llegará directo a la quinceañera 💌
          </Typography>
        </Box>
      </form>
    </>
