...
const CalendarIcon = () => (
  <Box sx={{ width: 50, height: 50, mx: "auto" }}>
    <svg viewBox="0 0 50 50" width="100%" height="100%" fill="none" stroke={T.textDark} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
const CupsIllustration = () => (
  <Box sx={{ width: { xs: 70, sm: 80 }, height: { xs: 60, sm: 70 }, mx: "auto" }}>
    <svg viewBox="0 0 140 105" width="100%" height="100%" fill="none" stroke={T.textDark} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
const PinIcon = () => (
  <Box sx={{ width: 40, height: 40, mx: "auto" }}>
    <svg viewBox="0 0 40 40" width="100%" height="100%" fill="none" stroke={T.textDark} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <Box sx={{ textAlign: "center", p: 3, maxWidth: 400, mx: "auto" }}>
      <Stack spacing={4} alignItems="center">
        ...
        <Box>
          <CalendarIcon />
          <Typography sx={{ ...scriptFont, color: T.gold, fontSize: 28, mt: 1 }}>
            Fecha
          </Typography>
          <Typography sx={{ ...serifFont, color: T.textDark, fontSize: 22, fontWeight: 500 }}>
            Sábado 27 Marzo
          </Typography>
        ...
        <Box>
          ...
          <Typography sx={{ ...serifFont, color: T.textDark, fontSize: 20, fontWeight: 500 }}>
            Centro Naval Callao
          </Typography>
        </Box>
